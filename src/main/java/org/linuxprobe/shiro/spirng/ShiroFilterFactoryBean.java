package org.linuxprobe.shiro.spirng;
...
import org.linuxprobe.shiro.security.filter.ShiroRootFilter;
...
public class ShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {
    ...
    private static transient final Logger log = LoggerFactory.getLogger(org.apache.shiro.spring.web.ShiroFilterFactoryBean.class);
    ...
    @Setter
    @Getter
    private ShiroRootFilter.ShiroFilterExceptionHandler exceptionHandler;
    ...
    protected AbstractShiroFilter createInstance() throws Exception {
        ...
        ShiroFilterFactoryBean.log.debug("Creating Shiro Filter instance.");
        ...
        ShiroRootFilter shiroRootFilter = new ShiroRootFilter((WebSecurityManager) securityManager, chainResolver);
        shiroRootFilter.setExceptionHandler(this.exceptionHandler);
        return shiroRootFilter;
    }
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof Filter) {
            ShiroFilterFactoryBean.log.debug("Found filter chain candidate filter '{}'", beanName);
            Filter filter = (Filter) bean;
            this.applyGlobalPropertiesIfNecessary(filter);
            this.getFilters().put(beanName, filter);
        } else {
            ShiroFilterFactoryBean.log.trace("Ignoring non-Filter bean '{}'", beanName);
        }
        return bean;
    }
