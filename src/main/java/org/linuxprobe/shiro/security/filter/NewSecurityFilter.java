...
@Setter
@NoArgsConstructor
public class NewSecurityFilter extends AdviceFilter {
    ...
    private String callbackURI = "/callback";
    private String homePage = "/";

    public NewSecurityFilter(List<Client<?>> clients, SessionKeyStore sessionKeyStore) {
